...
TEST(X86ISelPatternsTest, MatchAdd64) {
    ...
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Add, Type::getInt64Ty(), vregTypes, 0, 0);
...
TEST(X86ISelPatternsTest, MatchAdd32) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Add, Type::getInt32Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
...
TEST(X86ISelPatternsTest, MatchSub64) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Sub, Type::getInt64Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
...
TEST(X86ISelPatternsTest, MatchMul64) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Mul, Type::getInt64Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
...
TEST(X86ISelPatternsTest, MatchAnd64) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::And, Type::getInt64Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
...
TEST(X86ISelPatternsTest, MatchOr64) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Or, Type::getInt64Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
...
TEST(X86ISelPatternsTest, MatchXor64) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Xor, Type::getInt64Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
...
TEST(X86ISelPatternsTest, MatchShl64) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Shl, Type::getInt64Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
...
TEST(X86ISelPatternsTest, MatchLShr64) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::LShr, Type::getInt64Ty(), vregTypes, 0, 0);
    EXPECT_TRUE(result.matched);
}

TEST(X86ISelPatternsTest, NoMatchStore) {
    std::vector<unsigned> vregTypes;
    auto result = X86ISelPatterns::matchPattern(AIROpcode::Store, Type::getInt64Ty(), vregTypes, 0, 0);
