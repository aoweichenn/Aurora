...
- `include/minic/parse/` and `src/parse/`: parser facade, token cursor, type/declaration parsing, alignment specifiers, statements, initializers, compound literals, and expression precedence parsing.
- `include/minic/codegen/` and `src/codegen/`: codegen facade, AIR type conversion, function emission, declarations, statements, expressions, nested initializer and compound literal lowering, and analysis helpers.
